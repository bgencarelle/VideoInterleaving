...
EXPECTED = [
    ...
    ("scope_bake.py",
     ...
     ["XYLibrary", "merge", "raster_frame", "render_luma", "SweepSource", "content_bbox",
      "stochastic_luma", "StochasticEmitter", "StippleEmitter",
      "composite_stipple_candidates", "raster_precondition_for",
      "TriangleMixScheduler",
      "fusion_probability", "fuse_density", "PositionMultiplexer",
      "fuse_positions", "vector_density",
      "order_paths", "fit_epsilon",
      "subdivide", "path_length", "Q"]),
    ("scope_display.py",
    ...
    ("test_scope_stochastic.py",
     ...
     ["test_stochastic_shape_range_and_determinism",
      ...
      "test_stipple_is_stable_euclidean_and_rate_independent",
      "test_runtime_mode_handoff_starts_at_actual_beam_endpoint",
      "test_triangle_mix_preview_window_contains_every_active_component",
      "test_scope_tap_publishes_one_complete_mixed_exposure",
      "test_baked_manifest_matches_normal_folder_count_grouping_and_order",
      "test_pair_mixer_playback_is_not_gated_on_gui",
      "test_position_fusion_multiplexes_corresponding_array_entries",
      "test_fusion_density_supports_every_requested_component_set",
    ...
    ("scope_controls.py",
     "scope_controls.py -- live keyboard tuning",
     ["KeyMap", "Terminal", "as_flags", "SPECS", "HELP"]),
    ("scope_lowpass.py",
    ...
    (os.path.join("utilities", "convert_to_xy.py"),
     "XY Baker",
     ["vectorize", "make_thumb", "make_stipple_candidates", "process_folder",
      "PROFILES", "THUMB_W", "STIPPLE_CANDIDATES"]),
]
