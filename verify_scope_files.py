...
EXPECTED = [
    ...
    ("scope_bake.py",
     "scope_bake.py -- shared vector/raster/stochastic/fusion toolkit",
     ["XYLibrary", "merge", "raster_frame", "render_luma", "SweepSource", "content_bbox",
      "stochastic_luma", "StochasticEmitter", "TriangleMixScheduler",
    ...
    ("test_scope_stochastic.py",
     ...
     ["test_stochastic_shape_range_and_determinism",
      ...
      "test_combined_256_bake_triangle_mix_emits_all_three_paths"]),
    ("scope_screen.py",
