...
def configure_runtime():
    ...
    parser.add_argument("--modem-transport", choices=["v2","v3"], default="v2",
                        help="Wire format to transmit. v2 and v3 are NOT interoperable: "
                             "receive v2 with modem_v2_check, v3 with modem_v3_check.")
